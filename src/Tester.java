...
public class Tester {
	...
	public int countSpace(String str) {	
      ...
      if(str.length() == 0){
         ...
         return count + countSpace(str.substring(1));
	...
	private void recursiveSelectionSort(int a[], int low, int high) 
	{
            ...
            if(low < high){
        // create a placeholder reference to low representing the beginning of the list
        // create a way to start back at the beginning of the array where our smallest index is
        // create a for loop to iterate through the array
         ...
         for(int i = low + 1; i <= high; i++){
            ...
            // we now swap the smallest item in the list with low
            a[smallIndex] = a[low];
            a[low] = ref;
