public class MyLinkedList {
	...
	private MyLinkedList reverse(ListNode node) {
      if(node == null){
         ...
         reversedSubList.addLast(node.data);
         
         
		
		return reversedSubList; // change this line of code as needed
	}
   ...
   public void addLast(Object e){
	...
	private ListNode reverse(ListNode first, ListNode second) {
      ...
      ListNode rev = reverse(second, second.next);
         second.next = first;
         first.next = null;
         
      
		return rev;//change this line of code as needed.
	}
